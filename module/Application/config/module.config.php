...
return array(
    ...
    'service_manager' => array(
        'factories' => array(
            ...
            'Application\Authentication\MyAuthStorage' => function($sm){
                return new \Application\Authentication\MyAuthStorage('zf_contact_center'); 
            },
...
//                $authAdapter->setTableName('sys_usuarios')
//                    ->setIdentityColumn('username')
//                    ->setCredentialColumn('password');
//                 
//                // Y se lo pasamos a nuestro servicio
//                $authServiceManager->setAdapter($authAdapter);
//                $authServiceManager->setStorage($sm->get('Application\Authentication\MyAuthStorage'));
//                
